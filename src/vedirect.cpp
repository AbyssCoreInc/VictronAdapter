...
int _ve_direct_parse_block_raw_fields(ve_direct_block_t *block, char *block_text_in)
{
	...
	while ( (p = strstr(p, "\r\n")) != NULL) {
		...
		fptr_new = (ve_direct_raw_fields_t*)calloc(1, sizeof(ve_direct_raw_fields_t));
		if (fptr_new == NULL) {
...
int _ve_direct_add_field(ve_direct_block_t *block, char * field_name, ve_direct_value_type value_type, char *units, char *description)
{
	...
	p = (ve_direct_fields_t*)calloc(1, sizeof(ve_direct_fields_t));
	...
	p->name = (char*)malloc(strlen(field_name)+1);
...
ve_direct_block_t *ve_direct_parse_block(char *block_text_in)
{
	...
	block = (ve_direct_block_t*)calloc(1,sizeof(ve_direct_block_t));
	if (block == NULL) {
	...
	_ve_direct_add_field(block, (char*)"PID", ve_direct_value_type_hex, (char*)"", (char*)"Product ID");

	pid_p = (int*)ve_direct_get_field_value(block, (char*)"PID");
	if (pid_p != NULL) {
		block->pid = *(int *) pid_p;
	...
	//General
	_ve_direct_add_field(block, (char*)"V", ve_direct_value_type_int,    (char*)"mV", (char*)"Main or channel 1 battery voltage");
	_ve_direct_add_field(block, (char*)"I", ve_direct_value_type_int,    (char*)"mA", (char*)"Main or channel 1 battery current");
	_ve_direct_add_field(block, (char*)"SER#", ve_direct_value_type_str, (char*)"",   (char*)"Serial number of the device");

	//MPPT Charge Controller
	_ve_direct_add_field(block, (char*)"VPV", ve_direct_value_type_int, (char*)"mV", (char*)"Panel voltage");
	_ve_direct_add_field(block, (char*)"PPV", ve_direct_value_type_int, (char*)"W",  (char*)"Panel power");
	_ve_direct_add_field(block, (char*)"IL", ve_direct_value_type_int,  (char*)"mA", (char*)"Load current");

	//Inverter Stuff
	_ve_direct_add_field(block, (char*)"AC_OUT_V", ve_direct_value_type_int, (char*)"0.01V", (char*)"AC output voltage");
	_ve_direct_add_field(block, (char*)"AC_OUT_I", ve_direct_value_type_int, (char*)"0.1A",  (char*)"AC output current");
	_ve_direct_add_field(block, (char*)"T", ve_direct_value_type_int,   (char*)"C",          (char*)"Battery temperature");
	_ve_direct_add_field(block, (char*)"P", ve_direct_value_type_int,   (char*)"W",          (char*)"Instantaaneous power");
	_ve_direct_add_field(block, (char*)"CE", ve_direct_value_type_int,  (char*)"mAh",        (char*)"Consumed amp hours");
	_ve_direct_add_field(block, (char*)"SOC", ve_direct_value_type_int, (char*)"%",          (char*)"State-of-charge");
	_ve_direct_add_field(block, (char*)"TTG", ve_direct_value_type_int, (char*)"m",          (char*)"Time-to-go");
